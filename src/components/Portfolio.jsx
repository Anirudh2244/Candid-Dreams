...
function Portfolio() {
  return (
    <div className="mt-30 flex justify-center items-center flex-col  sm:gap-3 ">
      ...
      <div class="inline-flex items-center justify-center w-full  mb-10 sm:mb-5">
        ...
        <span class="px-3 text-2xl sm:text-4xl text-zinc-800 -translate-x-1/2 text-center bg-white absolute left-1/2">
          Latest Projects
        </span>
      </div>
